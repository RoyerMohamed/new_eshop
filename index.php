...
$_SESSION["itemData"] = [
   "item1" => [
    "itemPic" => "images/IMG_8923.jpg",
    "itemName" => "hoodie",
    "itemDescreption" => "Lorem ipsum dolor sit amet. Quo alias quia sit quaerat doloremque 
    cum ducimus eveniet qui tempora quibusdam et adipisci labore nam 
    voluptas similique aut nihil maxime",
     "itemPrice" => 19,99
   ],
  "item2" => [
    "itemPic" => "images/IMG_8924.jpg",
    "itemName" => "hoodie",
    "itemDescreption" => "Lorem ipsum dolor sit amet. Quo alias quia sit quaerat doloremque 
    cum ducimus eveniet qui tempora quibusdam et adipisci labore nam 
    voluptas similique aut nihil maxime",
...
<section>
    ...
    <div>
        <?php
        foreach ($_SESSION ["itemData"] as $product):
        ?><p><?= $product['itemPic']?></p>
  ...
  <div class="content">
    ...
    <div class="front">
      ...
      <div class="front-content">
        <small class="badge">hoodie</small>
